...
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/puffer_temp/*
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/1375135419_47_0.19.0.13908_20200714175353_1586798109_cures.ifs.res
...
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/puffer_res.eifs
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferFileList.json
sleep 1;
echo "                   \ Almost Done./"
sleep 1;
echo "                    \  Enjoy👍  /"
...
echo "                       *NOTE*"
echo ""
echo " 1.Execute this file Every time before play the game."
echo ""
echo " 2.This file is only for Global version."
